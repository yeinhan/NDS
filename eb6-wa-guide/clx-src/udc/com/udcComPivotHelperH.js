...
function onBtnTgglClick(/* cpr.events.CMouseEvent */ e){
	...
	if (!vbRwVs){ // 미표시 -> 표시
		vnStdHt = app.getAppProperty("maxHeight"); // 최대 사이즈 (default:250)

		btnTggl.style.removeClass("btn-header-plus");
		btnTggl.style.addClass("btn-header-minus");		
	} else { // 표시 -> 미표시
		btnTggl.style.removeClass("btn-header-minus");
		btnTggl.style.addClass("btn-header-plus");
	}
